 ...
 *
 *
 * Copyright Carlos Gustavo Cielo Torres , Raúl Ricardo Carmona Chaltelt & Marco Villavicencio Rodríguez
 *
 *
...
app.service('idiomaService', function($http, CONSTANT) {
   
   var idiomaStrings = new Object();
    
    this.getStringLanguages = function (idiomaChar) {
        
    switch(idiomaChar) {
          case 'ES':
            idiomaStrings = {
                BUSCAENTRE:"Busca entre más los miles de cuartos y roomies, y comparte nuevas historias con gente increíble", 
                VERLUGARES:"VER LUGARES"
                };
              break;
          case 'EN':
               idiomaStrings = {
                BUSCAENTRE:"Look among thousands of rooms and roomates, share new stories with awesome people", 
                VERLUGARES:"LOOK PLACES"
                };
              break;
          case 'FR':
              //
